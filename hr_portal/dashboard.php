...
// UPDATED: Use the new accumulated casual balance
$casual_available = $balance['casual_remaining_this_month'] ?? 0;
$casual_total_entitled = $balance['casual_total_entitled'] ?? 0;
$casual_used_this_month = $balance['casual_this_month'] ?? 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="app-main">
        ...
        <div class="main-content">
            ...
            <div class="policy-notice">
                <div><i class="fas fa-info-circle" style="color: #48bb78;"></i> Casual Leave: 1 day/month (accumulates)</div>
                <div class="usage-badge">Total entitled: <?php echo $casual_total_entitled; ?> days</div>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-sub">
                        Available: <?php echo $casual_available; ?> days<br>
                        Used this month: <?php echo $casual_used_this_month; ?>/<?php echo $casual_total_entitled; ?>
                    </div>
                </div>
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr><td>Casual</td><td><?php echo $casual_total_entitled; ?></td><td><?php echo ($casual_total_entitled - $casual_available); ?></td><td><?php echo $casual_available; ?></td><td><?php echo $casual_used_this_month; ?>/<?php echo $casual_total_entitled; ?></td></tr>
