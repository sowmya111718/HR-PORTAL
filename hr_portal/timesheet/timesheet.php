...
if (isset($_GET['edit'])) {
    ...
    if ($edit_entry && $edit_entry['user_id'] == $user_id && $edit_entry['status'] != 'approved') {
        if ($edit_entry['entry_date'] == $today_date) {
            ...
            $message = '<div class="alert alert-error">You can only edit timesheet entries for today\'s date. Past entries cannot be modified.</div>';
        }
    } else {
                                ...
                                <tr class="<?php echo $has_lop ? 'lop-entry' : ''; ?>">
                                    ...
                                    <td>
                                        <div class="action-buttons" style="display: flex; gap: 5px;">
                                            ...
                                            <?php elseif ($entry['user_id'] == $user_id && $entry['status'] != 'approved' && $entry['entry_date'] != $today_date): ?>
