...
if ($result->num_rows === 0) {
    echo '<div class="alert alert-error">Permission not found or access denied</div>';
    exit();
}
...
<body>
    ...
    <div class="app-main">
        ...
        <div class="main-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 class="page-title">Permission Details</h2>
            ...
            <div class="details-container">
                ...
                <div class="detail-card">
                    <h3 style="margin-bottom: 20px; color: #4a5568;"><i class="fas fa-user"></i> Employee Details</h3>
    ...
    <!-- Permission Details -->
<div class="detail-card">
    <h3 style="margin-bottom: 20px; color: #4a5568;"><i class="fas fa-clock"></i> Permission Details</h3>
    <div class="detail-row">
    ...
    <div class="detail-row">
        ...
        <span class="detail-value"><?php echo date('F j, Y g:i A', strtotime($permission['applied_date'])); ?></span>
                ...
                <!-- Status -->
                <div class="detail-card">
                    <h3 style="margin-bottom: 20px; color: #4a5568;"><i class="fas fa-info-circle"></i> Status</h3>
                    <div class="detail-row">
            ...
            <div class="card" style="margin-top: 20px;">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-comment"></i> Reason</h3>
                </div>
