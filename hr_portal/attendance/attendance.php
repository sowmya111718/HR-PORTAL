...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['mark_attendance'])) {
        ...
        if ($result->num_rows > 0) {
            $message = '<div class="alert alert-error">Attendance already marked for this date</div>';
        } else {
            $stmt = $conn->prepare("
            ...
            if ($stmt->execute()) {
                ...
                $message = '<div class="alert alert-error">Error marking attendance</div>';
            }
        }
        $stmt->close();
    }
...
if (isset($_GET['delete']) && in_array($role, ['hr', 'admin', 'pm'])) {
    ...
    if ($stmt->execute()) {
        $message = '<div class="alert alert-success">Attendance record deleted successfully</div>';
    } else {
        $message = '<div class="alert alert-error">Error deleting attendance record</div>';
    }
    $stmt->close();
}
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-calendar-check"></i> Attendance - <?php echo date('F Y', strtotime($selected_month)); ?></h3>
                ...
                <div class="stats-grid" style="margin-bottom: 30px;">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon" style="background: #fed7d7; color: #c53030;"><i class="fas fa-times-circle"></i></div>
                ...
                <div class="card" style="margin-bottom: 30px;">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-plus-circle"></i> Mark Attendance</h3>
                    </div>
    ...
    <div id="editModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <form method="POST" action="">
                ...
                <button type="submit" name="update_attendance" class="btn">Update Attendance</button>
            </form>
        </div>
    </div>
