...
if (isset($_POST['reset_timesheet_all']) && $role === 'admin') {
    ...
    if (isset($_POST['confirm_text_timesheet']) && !empty($_POST['confirm_text_timesheet'])) {
        ...
        if ($confirm_text === 'RESET TIMESHEET') {
            ...
            $message = '<div class="alert alert-success">All timesheet data has been cleared for all users.</div>';
        } else {
            $message = '<div class="alert alert-error">Please type "RESET TIMESHEET" exactly to confirm</div>';
        }
    } else {
        $message = '<div class="alert alert-error">Please enter the confirmation text</div>';
    }
            ...
            <div class="system-grid">
                ...
                <div class="system-card">
                    <div class="system-header">
                        <i class="fas fa-database"></i> Total System Data
                    </div>
                    ...
                    <div class="system-breakdown">
                        ...
                        <div class="breakdown-item">
                            <span class="breakdown-label">Timesht</span>
                            <span class="breakdown-number"><?php echo $stats['total_timesheets']; ?></span>
                        </div>
                        <div class="breakdown-item">
                            <span class="breakdown-label">Attend</span>
                ...
                <div class="system-card storage">
                    ...
                    <div class="system-breakdown">
                        ...
                        <div class="breakdown-item">
                            <span class="breakdown-label">Per Timesht</span>
                            <span class="breakdown-number">~1KB</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="danger-zone">
                ...
                <div class="reset-options">
                    ...
                    <div class="reset-card timesheet">
                        <h5><i class="fas fa-calendar-alt"></i> Reset Timesheet for All</h5>
                        <p style="color: #718096; margin-bottom: 15px; font-size: 14px;">
                        ...
                        <form method="POST" action="">
                            ...
                            <button type="submit" name="reset_timesheet_all" class="btn btn-purple" onclick="return confirm('Delete ALL timesheet entries for ALL users? This cannot be undone!')">
                                <i class="fas fa-trash"></i> Reset Timesheet (All Users)
                            </button>
                        </form>
                    </div>
