...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        $message = '<div class="alert alert-error">Please fill all password fields</div>';
    } elseif ($new_password !== $confirm_password) {
        $message = '<div class="alert alert-error">New password and confirm password do not match</div>';
    } elseif (strlen($new_password) < 6) {
        $message = '<div class="alert alert-error">New password must be at least 6 characters long</div>';
    } else {
...
<head>
    ...
    <title>Change Password - MAKSIM HR</title>
...
<body>
    ...
    <div class="app-main">
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-shield-alt"></i> Password Security Tips</h3>
                </div>
                <div style="padding: 20px;">
                    <ul style="list-style: none; padding-left: 0;">
                        <li style="margin-bottom: 10px; padding-left: 25px; position: relative;">
                            <i class="fas fa-check" style="color: #48bb78; position: absolute; left: 0;"></i>
