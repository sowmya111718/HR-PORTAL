...
if (isset($_POST['export_excel']) || isset($_POST['generate_excel'])) {
    ...
    if (empty($from_date) || empty($to_date)) {
        ...
        // If generate Excel button clicked - EXPORT ONLY APPROVED
        if (isset($_POST['generate_excel'])) {
            $approved_leaves = array_filter($all_leaves, function($leave) {
                return $leave['status'] === 'Approved';
            });
            generateExcel($approved_leaves, $from_date, $to_date, $user_id, $conn);
        }
    }
}

/**
 * Generate Excel file with leave data - EXACTLY like the screenshot
 */
function generateExcel($data, $from_date, $to_date, $user_id, $conn) {
    ...
    echo '<tr><td><strong>Applied:</strong></td><td>' . $total_applications . '</td></tr>';
    echo '<tr><td><strong>Days:</strong></td><td>' . number_format($total_days, 1) . '</td></tr>';
    echo '<tr><td><strong>Applications:</strong></td><td>' . $total_lop_apps . '</td></tr>';
    ...
    echo '<tr><td><strong>Days:</strong></td><td>' . number_format($casual_days, 1) . '</td></tr>';
            ...
            <div class="export-container">
                ...
                <div class="filter-card">
                    <div class="filter-title">
                        ...
                        <span class="approved-badge">
                            <i class="fas fa-check-circle"></i> Export Only Approved
                        </span>
                    </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <button type="submit" name="generate_excel" class="btn-preview">
                            <i class="fas fa-file-excel"></i> Export to Excel (Approved Only)
                        </button>
                        <?php endif; ?>
                    </form>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-eye"></i> Preview (<?php echo count($export_data); ?> records - including all statuses)
                        </h3>
                    ...
                    <div class="table-container">
                        ...
                        <div style="text-align: center; padding: 15px; color: #718096;">
                            ...
                            Showing first 20 of <?php echo count($export_data); ?> records. Export to Excel to see all approved records.
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
