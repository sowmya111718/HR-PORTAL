...
require_once '../includes/leave_functions.php'; // ADD THIS LINE
...
<head>
    ...
    <title>Leave Details - MAKSIM HR</title>
    ...
    <div class="app-main">
        ...
        <div class="main-content">
            ...
            <div class="details-container">
                ...
                <!-- Leave Details -->
                <div class="detail-card">
                    <h3 style="margin-bottom: 20px; color: #4a5568;"><i class="fas fa-umbrella-beach"></i> Leave Details</h3>
                    <div class="detail-row">
                ...
                <!-- Status & Dates -->
                <div class="detail-card">
                    <h3 style="margin-bottom: 20px; color: #4a5568;"><i class="fas fa-info-circle"></i> Status & Dates</h3>
                    <div class="detail-row">
