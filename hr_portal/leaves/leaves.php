...
if (isset($_GET['cancel'])) {
    ...
    if ($stmt->execute()) {
        $_SESSION['leave_message'] = '<div class="alert alert-success">Leave application cancelled successfully</div>';
    } else {
        $_SESSION['leave_message'] = '<div class="alert alert-error">Error cancelling leave application</div>';
    }
    $stmt->close();
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <form method="POST" action="" id="leaveForm">
                    ...
                    <button type="submit" name="apply_leave" id="submitBtn" class="btn">Apply Leave</button>
                </form>
            </div>
    ...
    // REMOVED: applyAsLOP and applyAsMixed functions since they're not used
    </script>
</body>
</html>