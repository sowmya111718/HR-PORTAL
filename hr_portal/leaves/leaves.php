    ...
    if ($from > $to) {
        ...
        if (empty($date_segments)) {
            ...
            foreach ($date_segments as $index => $segment) {
                ...
                $seg_from = new DateTime($segment_from);
                $seg_to = new DateTime($segment_to);
                $interval = $seg_from->diff($seg_to);
                $calendar_days = $interval->days + 1;
                
                $working_days = 0;
                $current_date = clone $seg_from;
                ...
                if ($calendar_days == 1) {
                    $segment_days = ($day_type === 'half') ? 0.5 : 1;
                } else {
                    $segment_days = ($day_type === 'half') ? $working_days * 0.5 : $working_days;
                }
            ...
            if ($applied_segments > 0) {
                ...
                $message = '<div class="alert alert-error">Error applying leave for available segments</div>';
            }
        }
    }
}
...
<body>
    ...
    <div class="app-main">
        ...
        <div class="main-content">
            ...
            <!-- Monthly Casual Leave Info - Added here as requested -->
            <div class="monthly-info">
                ...
                <br><span class="carry-forward"><i class="fas fa-arrow-right"></i> You have <?php echo $balance['casual_monthly']['carry_forward']; ?> day(s) carried forward from last month.</span>
                <?php endif; ?>
                <?php if (isset($balance['casual_monthly']['used_this_month']) && $balance['casual_monthly']['used_this_month'] > 0): ?>
                <br><span class="used-this-month"><i class="fas fa-check-circle"></i> You have used <?php echo $balance['casual_monthly']['used_this_month']; ?>/1 casual leave this month.</span>
                <?php endif; ?>
            </div>
            ...
            <div class="info-box">
                ...
                the system will automatically skip those dates and only apply for the available dates.
            </div>
                                ...
                                <tr <?php echo $is_lop ? 'class="lop-row"' : ''; ?>>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="leave_details.php?id=<?php echo $leave['id']; ?>" class="btn-view">
    ...
    // REMOVED: viewLeaveDetails function since we're using direct links now
