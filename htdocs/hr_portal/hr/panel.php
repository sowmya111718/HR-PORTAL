...
if (isset($_POST['export_permissions'])) {
    ...
    if ($export_permissions && $export_permissions->num_rows > 0) {
        while ($row = $export_permissions->fetch_assoc()) {
            ...
            // Delete button for permissions (PM/COO/ED only, NOT Admin)
            if (in_array($role, ['pm', 'ed'])) {
                ...
                echo "<span class='btn-small btn-delete-leave disabled' style='opacity:0.5; cursor:not-allowed;' title='Admin cannot delete - Use PM/COO/ED'><i class='icon-delete'></i> Delete</span>";
            }
...
// DELETE PERMISSION - Only for PM, COO, ED (NOT Admin)
if (isset($_GET['delete_permission']) && in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['approve_leave'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot approve leaves. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot approve leaves. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['reject_leave'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot reject leaves. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot reject leaves. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
...
// DELETE LEAVE HANDLING - Only for PM, COO, ED (NOT Admin)
if (isset($_GET['delete_leave']) && in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['approve_permission'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot approve permissions. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot approve permissions. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['reject_permission'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot reject permissions. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot reject permissions. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['approve_lop_permission'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot approve LOP permissions. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot approve LOP permissions. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
...
if (isset($_GET['reject_lop_permission'])) {
    ...
    if ($role === 'hr' || $role === 'coo') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> HR/COO cannot reject LOP permissions. Only PM and ED can.</div>';
    } elseif ($role === 'admin') {
        $message = '<div class="alert alert-error"><i class="icon-error"></i> Admins cannot reject LOP permissions. Use PM or ED.</div>';
    } elseif (!in_array($role, ['pm', 'ed'])) {
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <?php if ($leave['status'] == 'Pending'): ?>
                                                ...
                                                <?php elseif (in_array($role, ['pm', 'ed'])): ?>
                                            ...
                                            <?php if ($leave['status'] == 'Approved' && in_array($role, ['pm', 'ed'])): ?>
