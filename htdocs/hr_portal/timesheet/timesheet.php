...
<head>
    ...
    <style>
        ...
        .timesheet-row { display: grid; grid-template-columns: 0.6fr 0.5fr 1fr 1.5fr 1.3fr 0.8fr 0fr 0.6fr; gap: 10px; margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #e2e8f0; }
        .timesheet-row .form-label { font-size: 12px; margin-bottom: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .timesheet-row .form-control,
        .timesheet-row input[type="date"],
        .timesheet-row input[type="number"],
        .timesheet-row input[type="text"],
        .timesheet-row select { padding: 6px 7px; font-size: 12px; }
        .timesheet-row .time-input input { width: 52px; padding: 6px 4px; font-size: 12px; }
        .timesheet-row .software-checkbox-group,
        .timesheet-row .task-checkbox-group { max-height: 140px; font-size: 12px; }
        .timesheet-row .software-checkbox-item,
        .timesheet-row .task-checkbox-item { padding: 5px; font-size: 12px; }
        .timesheet-row .selected-software-badge,
        .timesheet-row .selected-tasks-badge { font-size: 11px; padding: 3px 6px; }
                                ...
                                <div id="task_dropdown_container" style="<?php echo (!empty($edit_data['task_name']) && strpos($edit_data['task_name'], ',') !== false) ? 'display: none;' : 'display: block;'; ?>">
                                    <div class="task-checkbox-group" id="multi_task_container">
                                        <?php if (!empty($all_tasks)): ?>
                                            ...
                                            elseif  (strpos($task['task_name'], 'Civil')        !== false) $icon = '🏚️';
                                            elseif  (strpos($task['task_name'], 'Structural')   !== false) $icon = '🏗️';
                                            elseif  (strpos($task['task_name'], 'Mechanical')   !== false) $icon = '⚙️';
                                            elseif  (strpos($task['task_name'], 'Plumbing')     !== false) $icon = '🚿';
                                            elseif  (strpos($task['task_name'], 'Instrumentation') !== false) $icon = '🎛️';
                                            elseif  (strpos($task['task_name'], 'Fire')         !== false) $icon = '🔥';
                                            elseif  (strpos($task['task_name'], 'Road')         !== false) $icon = '🛣️';
                                            ...
                                            elseif  (strpos($task['task_name'], 'Design')       !== false) $icon = '✏️';
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if ($timesheets && $timesheets->num_rows > 0): ?>
                                ...
                                elseif (strpos($display_task_name, 'Civil')        !== false) $task_icon = '🏚️';
                                elseif (strpos($display_task_name, 'Mechanical')   !== false) $task_icon = '⚙️';
                                elseif (strpos($display_task_name, 'Plumbing')     !== false) $task_icon = '🚿';
                                elseif (strpos($display_task_name, 'Instrumentation') !== false) $task_icon = '🎛️';
                                elseif (strpos($display_task_name, 'Fire')         !== false) $task_icon = '🔥';
                                elseif (strpos($display_task_name, 'Road')         !== false) $task_icon = '🛣️';
                                ...
                                elseif (strpos($display_task_name, 'Design')       !== false) $task_icon = '✏️';
                                ...
                                if (strpos($display_task_name, ',') !== false) {
                                    ...
                                    foreach ($task_parts as $tp) {
                                        ...
                                        elseif  (strpos($tp, 'Support')         !== false) $ti = '🛠️';
                                        elseif  (strpos($tp, 'Railing')         !== false) $ti = '🚧';
                                        elseif  (strpos($tp, 'Architecture')    !== false) $ti = '🏛️';
                                        elseif  (strpos($tp, 'Stair')           !== false) $ti = '▁▃▅▇ ';
                                        elseif  (strpos($tp, 'Equipment')       !== false) $ti = '⚙️';
                                        elseif  (strpos($tp, 'Piping')          !== false) $ti = '🔧';
                                        elseif  (strpos($tp, 'Structure')       !== false) $ti = '🏗️';
                                        elseif  (strpos($tp, 'HVAC')            !== false) $ti = '❄️';
                                        elseif  (strpos($tp, 'Civil')           !== false) $ti = '🏚️';
                                        elseif  (strpos($tp, 'Mechanical')      !== false) $ti = '⚙️';
                                        elseif  (strpos($tp, 'Plumbing')        !== false) $ti = '🚿';
                                        elseif  (strpos($tp, 'Instrumentation') !== false) $ti = '🎛️';
                                        elseif  (strpos($tp, 'Fire')            !== false) $ti = '🔥';
                                        elseif  (strpos($tp, 'Road')            !== false) $ti = '🛣️';
                                        elseif  (strpos($tp, 'Telecom')         !== false) $ti = '📡';
                                        elseif  (strpos($tp, 'QC')              !== false) $ti = '✅';
                                        elseif  (strpos($tp, 'Quality')         !== false) $ti = '✅';
                                        elseif  (strpos($tp, 'Design')          !== false) $ti = '✏️';
