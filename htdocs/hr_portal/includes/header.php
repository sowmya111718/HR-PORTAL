...
<div class="app-header">
    ...
    <div class="user-info">
        ...
        <div class="user-label <?php echo $_SESSION['role'] === 'hr' ? 'hr' : ($_SESSION['role'] === 'DM' ? 'dm' : ''); ?>">
            <i class="icon-user"></i> <?php echo $_SESSION['full_name']; ?>
            <span class="user-role-badge role-<?php echo strtolower($_SESSION['role']); ?>">
...
.role-COO { background: #e9d8fd; color: #553c9a; }
.role-ED { background: #fed7e2; color: #b83280; }
