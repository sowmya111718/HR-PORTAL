...
<div class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li><a href="<?php echo $base_path;?>hr/panel.php" class="<?php echo $current_page=='panel.php'?'active':'';?>"><i class="icon-hr"></i> HR Panel</a></li>
        ...
        <li><a href="<?php echo $base_path;?>hr/auto_lop.php" class="<?php echo $current_page=='auto_lop.php'?'active':'';?>">⚠️ Auto-Generated LOPs</a></li>
    ...
    <div style="margin:12px 10px 14px;background:#ffffff;border:1px solid #c7d2fe;border-radius:10px;padding:12px 13px;box-shadow:0 1px 4px rgba(99,102,241,0.08);">
        <div style="font-weight:700;font-size:11px;color:#4338ca;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:9px;">📅 Next 30 Days</div>
        ...
        <div>
            <div style="font-size:10px;font-weight:700;color:#818cf8;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:5px;">🏖️ Holidays &amp; Festivals</div>
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;padding:5px 8px;background:#f5f3ff;border-radius:6px;margin-bottom:3px;border-left:3px solid <?php echo $bdr;?>;">
                <div style="flex:1;min-width:0;">
                    <div style="font-weight:600;color:#3730a3;font-size:11.5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo $pfx.htmlspecialchars($h['holiday_name']);?></div>
                    <div style="color:#818cf8;font-size:10px;"><?php echo date('d M',strtotime($h['holiday_date']));?> · <?php echo date('D',strtotime($h['holiday_date']));?> · <span style="color:<?php echo $bdr;?>;"><?php echo $lbl;?></span></div>
                </div>
