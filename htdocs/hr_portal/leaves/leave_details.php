...
if ($role === 'employee') {
    ...
    // HR/Admin/Dm can view any leave
...
// Check if this leave includes any holidays
        ...
        <div class="main-content">
            ...
            <div class="details-container">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            ...
                            <?php if (isHoliday($leave['from_date'])): ?>
                                <span class="holiday-badge"><?php echo isHoliday($leave['from_date']); ?></span>
                            <?php endif; ?>
                        </span>
                    </div>
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            ...
                            <?php if (isHoliday($leave['to_date'])): ?>
                                <span class="holiday-badge"><?php echo isHoliday($leave['to_date']); ?></span>
                            <?php endif; ?>
                        </span>
                    </div>
                    <div class="detail-row">
                    ...
                    <!-- ADD THIS: Holiday Information -->
                    <?php if (!empty($holiday_dates)): ?>
                    <div class="detail-row">
                        <span class="detail-label">Holidays Included:</span>
                        <span class="detail-value">
                            <?php foreach ($holiday_dates as $h): ?>
                                <span class="holiday-badge" style="display: inline-block; margin: 2px;">
                                    <?php echo $h['date']; ?> (<?php echo $h['name']; ?>)
                                </span>
                            <?php endforeach; ?>
                        </span>
                    </div>
