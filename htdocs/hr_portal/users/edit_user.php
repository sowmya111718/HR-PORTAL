                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="role" class="form-control" required <?php echo $user['id'] == $_SESSION['user_id'] ? 'disabled' : ''; ?>>
                                ...
                                <option value="coo" <?php echo $user['role'] === 'coo' ? 'selected' : ''; ?>>COO (Chief Operating Officer)</option>
                                <option value="PM" <?php echo $user['role'] === 'PM' ? 'selected' : ''; ?>>Project Manager</option>
                                <option value="ed" <?php echo $user['role'] === 'ed' ? 'selected' : ''; ?>>ED (Executive Director)</option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label class="form-label">Status
                                <?php if (!in_array($_SESSION['role'], ['pm', 'admin', 'ed'])): ?>
